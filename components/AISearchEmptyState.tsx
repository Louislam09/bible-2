...
const BibleEmptyState = ({ onExamplePress }: { onExamplePress: (question: string) => void }) => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.iconContainer}>
                ...
                <View style={styles.sparkleContainer}>
                    <Icon name="Sparkles" size={24} color={theme.colors.notification} style={styles.sparkle1} />
                    <Icon name="Sparkles" size={16} color={theme.colors.notification} style={styles.sparkle2} />
                </View>
            </View>

            {/* Main Title */}
            <Text style={styles.title}>
                Explora las Escrituras con IA
            </Text>

            {/* Subtitle */}
            <Text style={styles.subtitle}>
                Haz preguntas sobre cualquier tema bíblico y recibe respuestas detalladas con versículos relevantes
            </Text>
                ...
                {exampleQuestions.map((example, index) => (
                    ...
                    >
                        <View style={styles.exampleIconContainer}>
                            <Icon name={example.icon as any} size={18} color={example.color} />
                        </View>
