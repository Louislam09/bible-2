    ...
    try {
      ...
      if (!pb.authStore.isValid) {
        Alert.alert(
          ...
          "You must be logged in to set a password."
        );
        return;
      }
      ...
      Alert.alert(
        "Error",
        "Failed to set password: " + (error.message || "Unknown error")
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Setting a password will allow you to log in with your email and password
        in addition to Google authentication.
      </Text>
