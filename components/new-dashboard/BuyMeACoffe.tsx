...
import { TouchableOpacity, Text, StyleSheet, Linking, View, Image, Animated } from 'react-native';
    ...
    return (
        <Animated.View style={{ transform: [{ scale }] }}>
            <TouchableOpacity onPress={handlePress} activeOpacity={0.8} style={styles.container}>
                <LinearGradient
                    // colors={[theme.colors.notification,'#f9d29d', '#f3a183', ]}
                ...
                >
                    <View style={styles.content}>
                        <SVGComponent />
                        <Text style={styles.text}>¡Apoya el Proyecto!</Text>
                    </View>
                </LinearGradient>
            </TouchableOpacity>
        </Animated.View>
