    ...
    return (
        ...
        >
            <View style={[{ display: index === 0 ? 'flex' : 'none', alignItems: 'flex-end', justifyContent: 'flex-end', paddingRight: 10 }]} >
                <Skeleton colorMode={colorMode} height={15} width={150} />
                <Spacer />
            </View>

            <View style={{ display: index === 0 ? 'flex' : 'none', alignItems: 'center', justifyContent: 'center' }}>
                <Skeleton colorMode={colorMode} height={15} width={250} />
                <Spacer />
            </View>

            <View style={{ display: 'flex', alignItems: 'center', flexDirection: 'row', gap: 10 }}>
                <Spacer height={8} />
                <Skeleton colorMode={colorMode} radius="round" height={20} width={20} />
                <Skeleton colorMode={colorMode} width={'93%'} height={20} />
            </View>
            <View style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <Spacer height={4} />
                <Skeleton colorMode={colorMode} width={'95%'} height={20} />
                <Skeleton colorMode={colorMode} width={'95%'} height={20} />
                <Spacer height={20} />
            </View>
        </MotiView>
