...
function PopoverTestContent() {
    ...
    return (
        <ScrollView
            ...
            <Text>
                The popover can adapt to content size, screen rotation, and keyboad
                visibility changes. Try it out!
            </Text>
            <View
                style={{
                    borderColor: 'gray',
    ...
    if (Platform.OS === 'web') {
        return (
            <View style={{ padding: 30 }}>
                <Text>Switch to iOS, Android, or your own device to test the Popover</Text>
            </View>
        )
    }
                ...
                <Section
                    ...
                    popovers={[
                        <TouchablePopover
                            ...
                            content={
                                <Text style={{ color: 'white' }}>
                                    Come to the dark side... (custom backgroundColor)
                                </Text>
                            }
                        />,
                        <TouchablePopover
                            ...
                            content={
                                <Text>
                                    You can sorta see through it! (custom backgroundColor)
                                </Text>
                            }
                        />,
                        <TouchablePopover
                        ...
                        <TouchablePopover
                            ...
                            content={
                                <Text>
                                    Maybe rounded isn't your thing? (custom borderRadius)
                                </Text>
                            }
                ...
                <Section
                    ...
                    popovers={[
                        ...
                        <TouchableOpacity
                            ...
                            <Text>
                                {tooltipPopoverVisible ? 'Hide Tooltip' : 'Show Tooltip'}
                            </Text>
                        </TouchableOpacity>,
                    ]}
                />
