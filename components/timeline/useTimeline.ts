...
import { wp, mapRange, scrollViewHeight, wpUI, viewportWidth } from './timelineConstants'
...
export const useTimeline = ({ startYear, endYear, interval }: UseTimelineProps) => {
  ...
  const avJCString = 'A.C'
  const futurString = 'futuro'
