  ...
  return (
    <>
      <button
        ...
        onClick={() => {
          const currentSize = Number(inputValue) || 16;
          const nextSize = calculateNextFontSize(
            currentSize,
            UpdateFontSizeType.decrement
          );
          updateFontSizeByInputValue(nextSize);
        }}
      ...
      <span className="toolbar-item font-size-input !p-0 !text-base">
        {inputValue}
      </span>
      ...
      {/* <input
        ...
        value={inputValue}
        disabled={disabled}
        className="toolbar-item font-size-input !text-black !border-gray-300"
