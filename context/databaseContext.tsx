...
export const DatabaseContext = createContext<DatabaseContextType>(initialContext);
...
export const DatabaseProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <DatabaseContext.Provider value={{ database, executeSql, strongDB, strongExecuteSql }}>
            {children}
        </DatabaseContext.Provider>
    );
};

export const useDBContext = (): DatabaseContextType => useContext(DatabaseContext);
