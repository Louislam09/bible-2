...
<body>
  <div class="quote-container">
    <p class="quote">
      "El temor de Jehová es el principio de la sabiduría,<br />
...
<body>
  <div class="quote-container" role="blockquote" aria-label="Proverbio bíblico">
    <p class="quote-text">"El prudente ve el peligro y lo evita; el inexperto sigue adelante y sufre las consecuencias."</p>
    <p class="quote-ref">Proverbios 22:3</p>
  </div>
</body>
</html>
`,
...
<body>
  <div class="quote-container" role="blockquote" aria-label="Proverbio bíblico">
    <p class="quote-text">"El hombre sabio oyó, y creció en ciencia; y el entendido adquirió habilidad."</p>
    <p class="quote-ref">Proverbios 1:5</p>
  </div>
</body>
</html>`,
  },
